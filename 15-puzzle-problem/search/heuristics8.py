...
def hs(board):
    ...
    goal_board = np.array([1,2,3,4,5,6,7,8,0]).reshape(3,3)
    ...
    tracemalloc.start()
    ListMoves = ""
    Printed_Board = open("results/h/Boards9.txt", "a")
    Results = open("results/h/Results9.txt", "a")
